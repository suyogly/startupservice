...
/** Brand icons (lucide-react v1+ omits trademarked logos). */
        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3 text-muted-foreground">
              <Link href="#" aria-label="Instagram" className="hover:text-foreground"><IconInstagram className="h-5 w-5" /></Link>
              <Link href="#" aria-label="Facebook" className="hover:text-foreground"><IconFacebook className="h-5 w-5" /></Link>
              <Link href="#" aria-label="LinkedIn" className="hover:text-foreground"><IconLinkedIn className="h-5 w-5" /></Link>
            </div>
          </div>
        </div>
